...
import { Send, Bot, User, Loader2, Github } from 'lucide-react';
...
export default function ChatWindow({ selectedRepository }) {
    ...
    const sendMessageMutation = useMutation({
        mutationFn: ({ message, repoUrl, convId }) =>
            chatAPI.sendMessage(message, repoUrl, convId),
        onSuccess: (data) => {
            // Add assistant response to messages
            setMessages(perv => [...preview, {
                role: 'assistant',
            ...
            <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-primary-500 to-primary-600">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-white">RepoWise Assistant</h2>
                ...
                {messages.length === 0 && (
                    <div className="text-center text-gray-500 mt-8">
                        ...
                        <h3 className="text-lg font-medium text-gray-700 mb-2">
                            Welcome to the RepoWise!
                        </h3>
                        <p className="text-sm">
                            Begin to ask question about the Repository...
                        </p>
                    </div>
                )}
